        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4">
              <a href="https://twitter.com/RocketScienceAJ" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#FF6B00] transition-colors">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                </svg>
              </a>
              <a href="https://www.facebook.com/profile.php?id=61574677777108" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#FF6B00] transition-colors">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" />
                </svg>
              </a>
              <a
                href="https://www.instagram.com/rocketscience912/"
                target="_blank"
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="tel:+17065251237" className="text-gray-400 hover:text-[#FF6B00] transition-colors">
                  (706) 525-1237
                </a>
              </li>
              <li>
                <a href="mailto:rocketscience.customs@gmail.com" className="text-gray-400 hover:text-[#FF6B00] transition-colors">
                  rocketscience.customs@gmail.com
                </a>
              </li>
              <li className="text-gray-400">
                Mon - Sat: 7:00 AM - 5:00 PM EST
              </li>
            </ul>
          </div>
        </div>
